...
import 'package:frontend/screens/register_info_muscle_screen.dart';

void main() {
  testWidgets('增肌信息补全页UI与交互', (tester) async {
    await tester.pumpWidget(const MaterialApp(
      home: RegisterInfoMuscleScreen(
        username: 'testuser',
        name: '张三',
        gender: '男',
    ...
    await tester.enterText(
      find.byWidgetPredicate(
          (w) => w is TextField && w.decoration?.hintText == '填写每周增肌量'),
      '1',
    );
    await tester.ensureVisible(find.text('下一步'));
    await tester.tap(find.text('下一步'));
